...
class TestTrackingPID(unittest.TestCase):
    ...
    def test_tracking_pid(self):
        ...
        self.listener.waitForTransform('/map', '/robot_base', rospy.Time(0),rospy.Duration(1.0))
        #(trans1,rot1) = self.listener.lookupTransform('/map', '/base_link', rospy.Time(0))
        (trans1,rot1) = self.listener.lookupTransform('/map', '/robot_base', rospy.Time(0))
        rospy.sleep(0.5)
        ...
        (trans2,rot2) = self.listener.lookupTransform('/map', '/robot_base', rospy.Time(0))
