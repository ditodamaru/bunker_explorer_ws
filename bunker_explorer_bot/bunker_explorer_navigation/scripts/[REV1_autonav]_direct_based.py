...
class TerminalLauncher(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.labels = [
            ...
            "Terminal 5 [Launch RTABMAP]",
            "Terminal 6 [Launch Keyboard Control]",
            "Terminal 7 [Map Saver]",
            "Terminal 8 [Debugging]",
            "Terminal 9 [GPS Launch Script]",
            "Terminal 10 [Perform AutoNav]"
        ]
    ...
    def startTerminal(self, index):
        ...
        if 0 <= index < len(commands):
            if index == 4:  # Terminal 3 (RTABMAP launch)
