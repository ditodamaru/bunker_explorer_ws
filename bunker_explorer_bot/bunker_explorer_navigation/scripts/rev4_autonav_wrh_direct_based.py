...
class TerminalLauncher(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.labels = [
            ...
            "Terminal 5 [Robot Lozalizaation]",
            "Terminal 6 [Navsat Transform]",
    ...
    def startTerminal(self, index):
        commands = [
            ...
            "roslaunch bunker_explorer_description navsat_transform_template.launch",
            ...
            "roslaunch bunker_explorer_navigation rev1_move_base_wrhouse.launch"
            #"roslaunch bunker_explorer_navigation rev3_bunker_nav_amcl.launch"
        ]

        if 0 <= index < len(commands):
            if index == 6:  # Terminal 3 (RTABMAP launch)
