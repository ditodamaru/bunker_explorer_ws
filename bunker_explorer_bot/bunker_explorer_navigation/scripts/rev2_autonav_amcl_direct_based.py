...
class TerminalLauncher(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.labels = [
            ...
            "Terminal 13 [Launch Keyboard Input]",
            "Terminal 14 [Launch Collect GPS Waypoints]",
            "Terminal 15 [Launch Collect SLAM Waypoints]",
            "Terminal 16 [Perform AutoNav SLAM]",
            "Terminal 17 [Select Bunker URDF file to launch]",
            "Terminal 18 [Launch IMU]",
    ...
    def startTerminal(self, index):
        commands = [
            ...
            "roslaunch bunker_explorer_keyboard keyboard_publish.launch",
            "roslaunch bunker_explorer_navigation rev3_collect_gps_waypoints.launch",
            "roslaunch bunker_explorer_navigation rev3_collect_slam_waypoints.launch",
