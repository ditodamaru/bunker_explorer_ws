...
#ifndef BUNKER_EXPLORER_SIMULATOR
#define BUNKER_EXPLORER_SIMULATOR

class BunkerExplorerSimulator {

public:

    BunkerExplorerSimulator(ros::NodeHandle *nh); // default constructor
    ~BunkerExplorerSimulator(); // default destructor
