...
void getParams()
{
    ros::param::get("/bunker_explorer_waypoint/x_vel", x_vel);
    ros::param::get("/bunker_explorer_waypoint/x_vel_time", x_vel_time);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/frequency", frequency);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/delay", delay);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/magnetic_declination_radians", magnetic_declination_radians);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/yaw_offset", yaw_offset);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/zero_altitude", zero_altitude);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/broadcast_utm_transform", broadcast_utm_transform);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/publish_filtered_gps", publish_filtered_gps);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/use_odometry_yaw", use_odometry_yaw);
    ros::param::get("/bunker_explorer_waypoint/navsat_transform/wait_for_datum", wait_for_datum);
}
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_odom = n.subscribe("/bunker_explorer_waypoint/odometry/filtered_map", 100, filtered_odom_CB);
    //ros::Publisher pubVel = n.advertise<geometry_msgs::Twist>("/husky_velocity_controller/cmd_vel",100);
    ros::Publisher pubVel = n.advertise<geometry_msgs::Twist>("/smoother_cmd_vel",100);
    ros::Publisher pubCalibrationNodeEnded = n.advertise<std_msgs::Bool>("/bunker_explorer_waypoint/calibrate_status",100);
    ...
    //write params file
    std::string path =  ros::package::getPath("bunker_explorer_waypoint") + "/params/navsat_params.yaml";
