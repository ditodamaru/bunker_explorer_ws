#!/usr/bin/env python
#this package based on converter_navgoal_sim.py
...
if not waypoint_files:
    ...
    #output_file = "/home/andi/catkin_redevel_ws/bunker_eplorer_ws/src/bunker_explorer_ws/tracking_pid/trajectories/waypoint_conv.yaml"
